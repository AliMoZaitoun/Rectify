...
return [
    ...
    'branches' => [
        'already_has_manager' => 'عذراً، هذا الفرع لديه مدير بالفعل. يرجى إعفاء المدير الحالي قبل تعيين مدير جديد.',
    ],
    ...
    'complaint' => [
        ...
        'history' => [
            ...
            'escalated' => 'تم تصعيد الشكوى تلقائياً إلى مدير الفرع',

        ],

        'max_reopens_reached' => 'عذراً، لقد تجاوزت الحد الأقصى المسموح به لإعادة فتح هذه الشكوى (3 مرات). يرجى التواصل مع خدمة العملاء مباشرة لمساعدتك.',
    ],
    ...
    'compensations' => [
        ...
        'client_required' => 'يجب تحديد العميل في حال كان التعويض مباشر وغير مرتبط بشكوى.',
    ],
